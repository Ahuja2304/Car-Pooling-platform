...
// Fix broken default marker icon bug in React-Leaflet
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route exact path='/signup' element={token ? <Navigate to="/" /> : <SignUp setToken={setToken} setActiveTrip={setActiveTrip} />} />
